...
namespace Umbraco.Core.Persistence.NoSqlRepositories
{
    ...
    internal abstract class RepositoryBase<TId, TEntity> : RepositoryBase, IReadRepository<TId, TEntity>, IWriteRepository<TId, TEntity>, IUnitOfWorkRepository
        where TEntity : class, IAggregateRoot
    {
        ...
        protected abstract TEntity PerformGet(string filter);
        /// <summary>
        /// Gets all entities of type TEntity or a list according to the passed in filter
        /// </summary>
        /// <param name="filter">NoSql filter</param>
        /// <returns></returns>
        public IEnumerable<TEntity> Get(string filter)
        {
            throw new NotImplementedException();
        }
        ...
        protected abstract int PerformCount(string filter);
        /// <summary>
