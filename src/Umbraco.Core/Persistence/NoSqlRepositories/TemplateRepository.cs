...
namespace Umbraco.Core.Persistence.NoSqlRepositories
{
    ...
    /// </summary>
    internal class TemplateRepository : AzureTablesRepositoryBase<int, ITemplate>, ITemplateRepository
    {
        ...
        internal TemplateRepository(IAzureTablesUnitOfWork work, CacheHelper cache, ILogger logger, IFileSystem masterpageFileSystem, IFileSystem viewFileSystem, ITemplatesSection templateConfig)
        ...
        protected override ITemplate PerformGet(string filter)
        {
