...
namespace Umbraco.Core.Persistence.NoSqlRepositories.Interfaces
{
    public interface IContentRepository : IRecycleBinRepository<IContent>, IDeleteMediaFilesRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets all published Content by the specified filter
        /// </summary>
        /// <param name="filter">Table filter to execute against published versions</param>
        /// <returns>An enumerable list of <see cref="IContent"/></returns>
        IEnumerable<IContent> GetByPublishedVersion(string filter);
        ...
        /// </summary>
        /// <param name="filter">Filter to excute</param>
        ...
        IEnumerable<IContent> GetPagedResults(string filter, int pageIndex, int pageSize, out long totalRecords,
